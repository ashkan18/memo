defmodule MemoWeb.UserAuthTest do
  use MemoWeb.ConnCase, async: true

  alias Memo.Accounts
  alias MemoWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, MemoWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      MemoWeb.Endpoint.subscribe(live_socket_id)
